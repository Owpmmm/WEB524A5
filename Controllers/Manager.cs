    ...
    public class Manager
    {
        ...
        public bool LoadEpisodes()
        {
            ...
            ds.Episodes.Add(new Episode
            {
                ...
                Genre = "Drama",
                ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXVeFf5pvID_iL4a9zkC6hICIyi_yEjcCL8A&s",
                Show = theBiggBoss
            });
            ds.Episodes.Add(new Episode
            {
                ...
                Genre = "Drama",
                ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMdlU7voPLOS4K8I2L5vNUsFkq8NQoi0qCig&s",
                Show = theBiggBoss
            });
            ...
            ds.Episodes.Add(new Episode
            {
                ...
                Genre = "Family",
                ImageUrl = "https://img.indiaforums.com/show/640x360/3/923-10-ka-dum.jpg",
                Show = theDusKaDum
            });
            ds.Episodes.Add(new Episode
            {
